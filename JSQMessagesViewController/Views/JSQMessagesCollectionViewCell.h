...
@property (weak, nonatomic, readonly) NSLayoutConstraint *incomingAvatarLeadingConstraint;
@property (weak, nonatomic, readonly)  UIImageView *deliveryStatus;
@property (weak, nonatomic, readonly)  UILabel *dateLabel;
@property (weak, nonatomic, readonly)   UILabel *UserNameLabel;
@property (weak, nonatomic, readonly)   UIView *guestView;
@property (weak, nonatomic, readonly) UIImageView *slideReplyView;
